...
static NSString * const SYUniqueIdentifierDefaultsKey = @"BFUniqueIdentifier";
@implementation UIDevice (SYAdd)
...
+ (NSString *)uniqueIdentifier {
    ...
    else
    {
        ...
        uuid = [defaults objectForKey:SYUniqueIdentifierDefaultsKey];
        if (!uuid) {
            uuid = [self generateUUID];
            [defaults setObject:uuid forKey:SYUniqueIdentifierDefaultsKey];
